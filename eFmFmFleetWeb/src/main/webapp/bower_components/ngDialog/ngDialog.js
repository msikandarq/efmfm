                    ...
                    open: function (opts) {
                        ...
                        $q.all({
                            ...
                            $dialog.html((options.overlay ?
                                '<div class="ngdialog-overlay"></div><div class="ngdialog-content" role="document" style = "border-radius:0px; padding:0px;"> <div class = "col-md-12 alertHeader"></div><div class = "col-md-12" style = "padding:20px; background-color:white"><p>' + template + '</p><button class = "btn btn-primary col-md-offset-4 col-md-4" ng-click="closeThisDialog()" style = "margin-top:20px">OK</button></div></div>' :
