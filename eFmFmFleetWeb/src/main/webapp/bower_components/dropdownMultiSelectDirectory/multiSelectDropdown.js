...
angular.module( 'multi-select-dropdown-span-three', ['ng'] ).directive( 'multiSelectDropdownSpanThree' , [ '$sce', '$timeout', '$templateCache', function ( $sce, $timeout, $templateCache ) {
    return {
        restrict: 
            'AE',
         ...
         */
         ...
         templateUrl: 
            'multi-select-dropdown-span-three.htm',                            
    ...
    var template = 
        '<span class="multiSelectDropdownSpanThree inlineBlock">' +
            // main button
        ...
        '</div>'+
    '</span>';
    $templateCache.put( 'multi-select-dropdown-span-three.htm' , template );
}]); 
...
angular.module( 'multi-select-dropdown-span-five', ['ng'] ).directive( 'multiSelectDropdownSpanFive' , [ '$sce', '$timeout', '$templateCache', function ( $sce, $timeout, $templateCache ) {
    return {
        restrict: 
            'AE',
         ...
         */
         ...
         templateUrl: 
            'multi-select-dropdown-span-five.htm',                            
    ...
    var template = 
        '<span class="multiSelectDropdownSpanFive inlineBlock">' +
            // main button
            '<button id="{{directiveId}}" type="button"' +                
                'ng-click="toggleCheckboxes( $event ); refreshSelectedItems(); refreshButton(); prepareGrouping; prepareIndex();"' +
                'ng-bind-html="varButtonLabel"' +
        ...
        '</div>'+
    '</span>';
    $templateCache.put( 'multi-select-dropdown-span-five.htm' , template );
}]); 
...
angular.module( 'multi-select-dropdown-span-six', ['ng'] ).directive( 'multiSelectDropdownSpanSix' , [ '$sce', '$timeout', '$templateCache', function ( $sce, $timeout, $templateCache ) {
    return {
        restrict: 
            'AE',
         ...
         */
         ...
         templateUrl: 
            'multi-select-dropdown-span-six.htm',                            
    ...
    var template = 
        '<span class="multiSelectDropdownSpanSix inlineBlock">' +
            // main button
            '<button id="{{directiveId}}" type="button"' +                
                'ng-click="toggleCheckboxes( $event ); refreshSelectedItems(); refreshButton(); prepareGrouping; prepareIndex();"' +
                'ng-bind-html="varButtonLabel"' +
        ...
        '</div>'+
    '</span>';
    $templateCache.put( 'multi-select-dropdown-span-six.htm' , template );
}]); 


'use strict'

angular.module( 'multi-select-dropdown-without-selectall', ['ng'] ).directive( 'multiSelectDropdownWithoutSelectall' , [ '$sce', '$timeout', '$templateCache', function ( $sce, $timeout, $templateCache ) {
    return {
        restrict: 
            'AE',
         ...
         */
         ...
         templateUrl: 
            'multi-select-dropdown-without-selectall.htm',                            
    ...
    var template = 
        ...
        '</div>'+
    '</span>';
    $templateCache.put( 'multi-select-dropdown-without-selectall.htm' , template );
}]); 
...
angular.module( 'multi-select-dropdown-span-three-facility', ['ng'] ).directive( 'multiSelectDropdownSpanThreeFacility' , [ '$sce', '$timeout', '$templateCache', function ( $sce, $timeout, $templateCache ) {
    return {
        restrict: 
            'AE',
         ...
         */
         ...
         templateUrl: 
            'multi-select-dropdown-span-three-facility.htm',                            
        ...
        link: function ( $scope, element, attrs ) {                       
            ...
            if ( typeof attrs.translation !== 'undefined' ) {
                ...
                $scope.lang.reset           = $sce.trustAsHtml( $scope.icon.reset      + '&nbsp;&nbsp;Reset' );
                $scope.lang.search          = 'Search...';
                $scope.lang.nothingSelected = 'Select Facility';                
            }
            $scope.icon.tickMark = $sce.trustAsHtml( $scope.icon.tickMark );
    ...
    var template = 
        ...
        '</div>'+
    '</span>';
    $templateCache.put( 'multi-select-dropdown-span-three-facility.htm' , template );
}]); 