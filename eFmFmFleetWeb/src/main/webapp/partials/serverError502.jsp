...
<html lang="en">
<head>
  <title>eFmFm - Internal Server Error</title>
  <meta charset="utf-8">
        ...
        <div class="col-md-12">
            <div class="error-template">
                <h1>
                    Oops!</h1>
                <h2>
                    502 Internal Server Error</h2>
                <div class="error-details">
                    Sorry, Something went wrong! The remote server returned and error (internal Server Error)
                </div>
