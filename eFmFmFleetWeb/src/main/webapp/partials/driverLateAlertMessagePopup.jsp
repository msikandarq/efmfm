...
@date           03/01/2016
@Author         Saima Aziz
@Description    Custom Alert Popups for Drivers. This popups check the backend after every 10 secs
@State          
@URL              
            ...
            <div class ='col-md-12 alertDriverLateBody height100Perct'>
                <div class = " row height95Perct">
                    ...
                    <div class = "col-md-10 col-xs-8 height80Perct" class = "sosAlertMsg overflowAuto">
                        <span><strong>Driver Auto Checkout</strong></span><br />
                        <span>System is going to auto checkout this driver after 12 hours</span>
                        <ul>
