...
<div class="modal-body modalMainContent">    
 <form class='importEmpForm' id="addinstgroup" action="services/xlUtilityEmployeeUpload/employeeTravelTrip"
 ...
 <div class="fileinput fileinput-new input-group " data-provides="fileinput">
     ...
     <div class="modal-footer modalFooter">  
           <button type="button" class="btn btn-info floatLeft" ng-model = "request.submit" id='imp_stud' ng-click = "importEmpFile()" ng-disabled="!myForm.$valid">Submit</button>
