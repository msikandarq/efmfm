  ...
  <div class = "row">
    <div class="modal-header modal-header1 col-md-12">
      <div class = "row"> 
        ...
        <div class = "modalHeading col-md-10 floatLeft">Cut Of Notifications
    ...
    <div class = "row" ng-repeat="cutOffNotification in cutOffNotifications">
        ...
        <label>Notification Type</label>
            <select ng-model="cutOffNotification.routing" 
                    class="form-control"
                    ng-options="routeCutoff.text for routeCutoff in routeCutoffs"
...
<!--         <div class = "col-md-2">
        ...
        <div class = "col-md-2 timePickerAlign" ng-if = "cutOffNotification.routing">
     ...
     <!--      <div class = "col-md-2">
       ...
       <!--   <div class = "col-md-2 timePickerAlign" ng-if="cutOffNotification.routing == 'Yes'">
