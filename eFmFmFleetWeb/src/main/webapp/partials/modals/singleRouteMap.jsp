 ...
 <div class = "row">
        ...
        <div class="modal-headerMap modal-header1 col-md-12">
           <div class = "row"> 
            ...
            <div class = "modalHeading col-md-10 floatLeft">{{route.routeName}} Route Map View</div>
    ...
    <!-- <pre>{{empDetails | json}}</pre> -->
          ...
          <table class="table table table-bordered table-striped table-responsive height100Perct" >    
              <thead>
                  <tr class="singleRouteMapTable">
                      
                      <th class="col15 text-center"><strong>Route Id</strong>  :  {{route.routeId}}</th>
                      <th class="col15 text-center"><strong>Date</strong>  :  {{route.tripActualAssignDate}}</th>
                      <th class="col20 text-center"><strong>Trip Type</strong>  :  {{route.tripType}}</th>
                      <th class="col20 text-center"><strong>Shift Time</strong>  :  {{route.shiftTime}}</th>
                      <th class="col30 text-center"><strong>Route Name</strong>  :  {{route.routeName}}</th>
                  </tr>
              </thead>
