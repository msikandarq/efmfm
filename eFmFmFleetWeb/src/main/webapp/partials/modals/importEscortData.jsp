...
<div class="importEmployeeModal container-fluid">
	<div class="row">
		<div class="modal-header modal-header1 col-md-12">
			<div class="row">
				...
				<div class="modalHeading col-md-8 floatLeft">Import Escort
					Master Data</div>
	...
	<div class="modal-body modalMainContent">
		<form class='importEmpForm' id="addinstgroup"
			action="services/escort/escortDetails" method="post"
			enctype="multipart/form-data" class="form-horizontal form-bordered"
			name="myForm">
			<div class="fileinput fileinput-new input-group "
				data-provides="fileinput">
				<div class="form-control  col-md-6 col-xs-6"
				...
				<span class="input-group-addon btn btn-default btn-file"> 
                    ...
                    <input type="file"
					id="filenameforactivity" name="filename" class="default"
...
-->
			...
			<div class="modal-footer modalFooter">
				<button type="button" class="btn btn-info floatLeft" id='imp_stud'
					ng-click="importEmpFile()" ng-disabled="!myForm.$valid">Submit</button>
				<button type="button" class="btn btn-close floatLeft"
