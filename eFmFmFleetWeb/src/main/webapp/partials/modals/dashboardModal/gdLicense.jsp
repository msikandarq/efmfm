    ...
    <div class = "row">
        ...
        <div class="modal-header2 col-md-3">
                    <button class = "btn btn-sm btn-success form-control modalExcelbtn floatRight" 
                            ng-click = "saveInExcel('gdLicense')">
...
<div id = "exportExcelLicenseDue" class="modal-body modalMainContent" ng-show = "gotDriverGovernanceNotification">
    <table class="table table-bordered table-responsive container-fluid dashboardTable">
        ...
        <div class="dashboardAlertContainer">
          <i class="icon-thumbs-down-alt redDashboardStatus"></i> - <span class="redDashboardStatus">Red (License Will be expire In 10 Days)</span>  | <i class="icon-warning-sign yellowDashboardStatus"></i> - <span class="yellowDashboardStatus">Yellow (License Will be expire In 20 Days) </span>| <i class="icon-thumbs-up-alt greenDashboardStatus"></i> - <span class="greenDashboardStatus">Green (30 Days)</span>
        </div> 
        <br>
            <tr ng-repeat = "roadAlert in sosRoadAlertsData | filter:filterSearch: filterSearchFlag | filter: searchRoadAlerts" ng-class="{dangerStyle: roadAlert.colorFlg == 'R' , warningStyle: roadAlert.colorFlg == 'Y' , successStyle: roadAlert.colorFlg == 'G'}">
                  ...
                  <td class = "col-md-2">{{roadAlert.licenceExpDate}}</td>      
