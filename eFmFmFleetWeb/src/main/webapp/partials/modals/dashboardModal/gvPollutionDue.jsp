    ...
    <div class = "row">
        ...
        <div class="modal-header2 col-md-3">
            <button class = "btn btn-sm btn-success form-control modalExcelbtn floatRight" 
                    ng-click = "saveInExcel('gvPollution')">
...
<div id = "exportExcelPollutionDue" class="modal-body modalMainContent" ng-show = "vehicleGovernanceNotification">
    <table class="table table-bordered table-responsive container-fluid dashboardTable">
        ...
        <div class="dashboardAlertContainer" ng-if = "sosRoadAlertsData.length>0">
          <i class="icon-thumbs-down-alt redDashboardStatus"></i> - <span class="redDashboardStatus">Red (Pollution Due Will be expire In 10 Days)</span>  | <i class="icon-warning-sign yellowDashboardStatus"></i> - <span class="yellowDashboardStatus">Yellow (Pollution Due Will be expire In 20 Days) </span>| <i class="icon-thumbs-up-alt greenDashboardStatus"></i> - <span class="greenDashboardStatus">Green (30 Days)</span>
        </div>
        <tbody ng-if = "sosRoadAlertsData.length>0">
