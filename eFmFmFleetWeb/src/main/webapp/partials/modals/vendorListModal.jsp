	...
	<div class = "row">
        <div class="modal-header modal-header1 col-md-12">
           <div class = "row"> 
            ...
            <div class = "modalHeading col-md-8 floatLeft">Select Vendor</div>
...
<div class="modal-footer modalFooter">    
	<button type="button" class="btn btn-warning buttonRadius0" ng-click = "submitVendor(vendor)" ng-disabled="remarksForm.$invalid"
            >Ok</button> 
