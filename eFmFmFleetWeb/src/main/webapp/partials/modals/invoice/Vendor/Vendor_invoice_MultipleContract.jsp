                                ...
                                <table class = "invoiceTable invoiceByVendorTable table table-bordered table-responsive container-fluid VehicleInvoiceWidth" >
                                     <thead class ="tableHeading">
                                        ...
                                        <tr>
                                            ...
                                            <th class = "" ng-show="invoiceByVendorData.contractType == 'FDC'"><div><span>Contracted KMs</span></div></th>
                                            <th class = "" ng-show="invoiceByVendorData.contractType == 'FDC'"><div><span>Contracted Amount</span></div></th>
                                            <th class = "" ng-show="invoiceByVendorData.contractType == 'PDDC'"><div><span>Per Day Amount</span></div></th>
                                            <th class = "" ng-show="invoiceByVendorData.contractType == 'PDDC'"><div><span>Per Km Amount</span></div></th>
                                    ...
                                    <tbody class = "invoiceTbody invoiceBodyByVendor">   
                                        <tr ng-repeat = 'invoice in vendorFixedDistanceBasedData' ng-class="{modifiedColorInvoice: invoice.approvalStatus == 'M'}">                                        
                                          ...
                                          <td class='col-md-1' ng-show="invoice.contractType == 'FDC'">{{invoice.contractedKm}}</td> 
                                          <td class='col-md-1' ng-show="invoice.contractType == 'FDC'">{{invoice.contractAmount}}</td> 
                                          <td class='col-md-1' ng-show="invoice.contractType == 'PDDC'">{{invoice.contractPerDayAmount}}</td> 
                                          <td class='col-md-1' ng-show="invoice.contractType == 'PDDC'">{{invoice.perKmCost}}</td>
                                          <td class='col-md-3'>
                                          ...
                                          <td class='col-md-1'>{{invoice.totalKmAmount}}</td>
                                          <!-- <td class='col-md-3'> 
