                    ...
                    <td colspan = "12">
                        <div class = "secondTableDiv row"><div class = "col-md-12 paddingLeft0">
                            <table class = "invoiceTable invoiceByVendorTable table table-bordered table-responsive container-fluid VehicleInvoiceWidth" >
                                <thead class ="tableHeading">
                                    ...
                                    <tr>
                                            ...
                                            <th class = "" ng-show="vehicleFixedDistanceBasedData.contractType == 'FDC'"><div><span>Contracted KMs</span></div></th>
                                            <th class = "" ng-show="vehicleFixedDistanceBasedData.contractType == 'FDC'"><div><span>Contracted Amount</span></div></th>
                                            <th class = "" ng-show="vehicleFixedDistanceBasedData.contractType == 'PDDC'"><div><span>Per Day Amount</span></div></th>
                                            <th class = "" ng-show="vehicleFixedDistanceBasedData.contractType == 'PDDC'"><div><span>Per Km Amount</span></div></th>
                                ...
                                <tbody class = "invoiceTbody invoiceBodyByVendor">   
                                    ...
                                    <tr >                                        
                                      ...
                                      <td class='col-md-1' ng-show="vehicleFixedDistanceBasedData.contractType == 'FDC'">{{vehicleFixedDistanceBasedData.contractedKm}}</td> 
                                      <td class='col-md-1' ng-show="vehicleFixedDistanceBasedData.contractType == 'FDC'">{{vehicleFixedDistanceBasedData.contractAmount}}</td> 
                                      <td class='col-md-1' ng-show="vehicleFixedDistanceBasedData.contractType == 'PDDC'">{{vehicleFixedDistanceBasedData.contractPerDayAmount}}</td> 
                                      <td class='col-md-1' ng-show="vehicleFixedDistanceBasedData.contractType == 'PDDC'">{{vehicleFixedDistanceBasedData.perKmCost}}</td>
					     ...
					     ng-change = "checkTotalKmValue(vehicleFixedDistanceBasedData, $index)"
                                             ng-model = "vehicleFixedDistanceBasedData.totalKm"></td>
                                      <td class='col-md-1'>{{vehicleFixedDistanceBasedData.totalKmAmount}}</td>
                                      <!-- <td class='col-md-1'>
