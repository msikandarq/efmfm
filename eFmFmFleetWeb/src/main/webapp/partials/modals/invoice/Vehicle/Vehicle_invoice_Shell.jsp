                            ...
                            <table class = "invoiceTable invoiceByVendorTable table table-bordered table-responsive container-fluid VehicleInvoiceWidth" >
                                <thead class ="tableHeading">
                                    <tr>
                                        <th class = "vendorNameHeading" colspan = "14">
                                            ...
                                            <th class = ""><div><span>Penalty9</span></div></th>
                                            <th class = ""><div><span>Deduction10</span></div></th>
                                            <th class = ""><div><span>Penalty Net Amount<br /> (After deduction)11</span></div></th>   

                                            <th class = "totalKmTd"><div><span>Total Amount12<br /> (Amount + Ex KM Amt)</span></div></th>
                                            <th>Remarks</th>
                                            <th>Edit</th>
                                        </tr> 
                                </thead>
                                <tbody class = "invoiceTbody invoiceBodyByVendor">   
                                    ...
                                    <tr >                                        
                                      ...
                                      <td class='col-md-1'>{{vehicleFixedDistanceBasedData.contractedKm}}</td>
                                      <td class='col-md-1'>{{vehicleFixedDistanceBasedData.contractAmount}}</td>
                                      <td class='col-md-1'>
                                      ...
                                      <td class='col-md-1'>
                                          ...
                                          <!-- <input ng-show = "vehicleFixedDistanceBasedData.editByVehicleInvoiceClicked" 
                                                 type = 'text' ng-change = "checkTotalKmValue(vehicleFixedDistanceBasedData, $index)"
                                                 class = "form-control" 
                                                 ng-model = "vehicleFixedDistanceBasedData.extraKm"> -->
                                      </td>
                                      <td class='col-md-1'>
