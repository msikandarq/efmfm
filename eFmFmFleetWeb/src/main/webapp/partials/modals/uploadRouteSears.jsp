    ...
    <div class = "row">
        <div class="modal-header modal-header1 col-md-12"> 
            <div class = "row">
                ...
                <div class = "modalHeading col-md-8 floatLeft">Sears Employee Request</div>
...
<div class="modal-body modalMainContent">    
 <form class='importEmpForm' id="addinstgroup" action="services/searsxlImport/searsEmpRoaster"
...
<!--        <a href="#" class="input-group-addon btn btn-default fileinput-exists" data-dismiss="fileinput">Remove</a>-->
     ...
     <div class="modal-footer modalFooter">  
           <button type="button" class="btn btn-info floatLeft" id='imp_stud' ng-click = "uploadFile()" ng-disabled="!myForm.$valid">Submit</button>
