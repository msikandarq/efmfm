  ...
  <div class = "row">
        <div class="modal-header modal-header1 col-md-12">
           <div class = "row"> 
            ...
            <span ng-if = "addPickupLocation">Add</span> <span ng-if = "!addPickupLocation">Edit</span> Pickup Location</div>
    ...
    <div class="modal-body addNewShiftTimeModal modalMainContent">
       <form class = "addPickUplocation" name = "addPickUplocation">
         <div class = "userInfo_adminForm row">
                <div class ='col-md-6'>
                    <label>Start Area Name</label><br>
                    <select ng-model="location.startAreaPickup"
                      class="form-control" 
                ...
                <div class ='col-md-6'>
                    ...
                    <select ng-model="location.endAreaPickup"
                      class="form-control" 
                      ng-options="allZoneData.areaName for allZoneData in (allZonesData | filter: { areaName: '!' + location.startAreaPickup.areaName }) track by allZoneData.areaId"
                      required>
...
<div class="modal-footer modalFooter"> 
  <button type="button" class="btn btn-success buttonRadius0 noMoreClick" 
            ng-click = "saveAddPickUplocation(location)" 
            ng-disabled="addPickUplocation.$invalid">Save</button> 
